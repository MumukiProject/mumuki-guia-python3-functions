As we can see,thefunctions have a _name_ (in this case `is_longer_than`) that we will have to _devise_ when defining the function, and then write it exactly the same every time we use it.
